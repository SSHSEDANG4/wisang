...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/lesta-1/wisang/main/ssr/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/lesta-1/wisang/main/ssr/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/lesta-1/wisang/main/ssr/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/lesta-1/wisang/main/ssr/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr https://raw.githubusercontent.com/lesta-1/wisang/main/ssr/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/lesta-1/wisang/main/ssr/renewssr.sh && chmod +x /usr/bin/renewssr
