...
#install ssr
wget https://raw.githubusercontent.com/lesta-1/wisang/main/ssr/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/lesta-1/wisang/main/sdw/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#install v2ray
wget https://raw.githubusercontent.com/lesta-1/wisang/main/vray/ins-vt.sh && chmod +x ins-vt.sh && sed -i -e 's/\r$//' ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install L2TP
wget https://raw.githubusercontent.com/lesta-1/wisang/main/ipsec/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
...
echo ""  | tee -a log-install.txt
echo "------------------No Comment By Rpj Wisang-----------------" | tee -a log-install.txt
echo ""
echo " Reboot 15 Sec"
sleep 15
reboot
